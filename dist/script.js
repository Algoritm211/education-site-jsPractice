...
window.addEventListener('DOMContentLoaded', function () {
  var slider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_2__["default"]({
    container: '.page',
    buttons: '.next'
  });
  slider.render();
  var showUpSlider = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_3__["default"]({
  ...
  showUpSlider.init();
  var modulesSlider = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_3__["default"]({
  ...
  video.init();
  var difference = new _modules_difference__WEBPACK_IMPORTED_MODULE_0__["default"]('.officerold', '.officernew', '.officer__card-item');
  difference.init();
});
      ...
      this.buttons.forEach(function (button) {
        button.addEventListener('click', function () {
          ...
          if (document.querySelector('iframe#frame')) {
            ...
            var path = button.getAttribute('data-url');
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    key: "showSlides",
    value: function showSlides(itemIndex) {
      var _this = this;
    ...
    key: "changeSlides",
    value: function changeSlides(itemIndex) {
...
/*#__PURE__*/
function (_Slider) {
  _inherits(SliderMini, _Slider);

  function SliderMini(_ref) {
    var container = _ref.container,
        next = _ref.next,
        prev = _ref.prev,
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(SliderMini).call(this, {
      container: container,
      next: next,
      prev: prev,
